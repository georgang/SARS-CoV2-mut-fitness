...
if __name__ == '__main__':
    ...
    '''
        This script visualises 'counts_deer.csv' and stores the relative mutation rates in 'rates_deer.csv'.
    '''

    # Read file with mutation data
    df_mut = pd.read_csv('results/counts_deer.csv')
    ...
    df.to_csv('/Users/georgangehrn/Desktop/SARS2-mut-fitness-corr/matrix_factorization/rates_deer.csv', header=False)
